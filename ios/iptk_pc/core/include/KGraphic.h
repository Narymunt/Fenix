...
public:			
	...
	virtual bool CreateRenderTarget(int width, int height) = 0;
	virtual bool startRenderToTexture() = 0;
	virtual bool endRenderToTexture() = 0;
	...
	virtual	bool			loadPicture(  const	char	*filename , bool hiDef=true , bool hasalpha=true )  =0;	
