...
public:	
	...
	static	void		initInput( KWindow * kwindow ); //  /*HWND		hwnd*/ int screen_width, int screen_height ) ;
	static	void		initInputEx( HWND		hwnd, int screen_width, int screen_height ) ;
