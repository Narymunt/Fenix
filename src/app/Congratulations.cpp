...
{	
	...
	if (pScreen->_iSizeX < 1500)
	{
		_pExitButton->setHotCoords((pScreen->_iSizeX / 2) - 64, pScreen->_iSizeY - 128, (pScreen->_iSizeX / 2) + 64, pScreen->_iSizeY);
	}
	else
	{
		_pExitButton->setHotCoords((pScreen->_iSizeX / 2) - 128, pScreen->_iSizeY - 256, (pScreen->_iSizeX / 2) + 128, pScreen->_iSizeY);
	}
