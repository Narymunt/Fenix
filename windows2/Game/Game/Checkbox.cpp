...
CCheckbox::CCheckbox(char cScript[])	// najwygodniejsza metoda 
{
...
CCheckbox::CCheckbox(bool isSet)
{
	m_isSet = isSet;
}

CCheckbox::CCheckbox(bool isSet, int iX, int iY, char cFilenameON[], char cFilenameOFF[])
{
	m_isSet = isSet;
	m_iX = iX; 
	m_iY = iY; 
...
CCheckbox::CCheckbox(bool isSet, int iX, int iY, int iX1, int iY1, int iX2, int iY2, char cFilenameON[], char cFilenameOFF[])
{
	m_isSet = isSet;
	m_iX = iX; 
	m_iY = iY; 
...
CCheckbox::CCheckbox(bool isSet, int iX, int iY, char cFilenameON[], char cFilenameOnOver[], char cFilenameOFF[], char cFilenameOffOver[])
{
	m_isSet = isSet;
	m_iX = iX; 
	m_iY = iY; 
