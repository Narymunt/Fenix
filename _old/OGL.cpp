...
int oglInit(int iScreenX, int iScreenY, int bpp, Uint32 flags)
{
	...
	if (SDL_SetVideoMode(iScreenX, iScreenY, bpp, SDL_OPENGL | flags) == NULL)
		return -1;
...
// flip the buffers, use only to update the screen
