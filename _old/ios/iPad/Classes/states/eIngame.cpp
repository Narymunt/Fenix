...
void eIngame::Open(int iLevel, CScreen *pScreen)
{
	...
	m_ulScore = 0;			// iloúÊ punktÛw
	m_ucScoreMulti = (unsigned char) iLevel -1;		// jaki mnoønik
    ...
    if (_iOS == IPAD_HD)
    {
        m_pTimeBar = new CSprite((char*)"bar_time64.png");
        m_pExpBar =  new CSprite((char*)"bar_exp64.png");
        m_pGreyBar = new CSprite((char*)"bar_grey64.png");
    }
    else
    {
        m_pTimeBar = new CSprite((char*)"bar_time.png");
        m_pExpBar =  new CSprite((char*)"bar_exp.png");
    ...
    if (_iOS == IPAD_HD)
    {
        m_pBoard = new CSprite((char*)"board1024.png");
        m_pBoard->SetPosition(512,128);
        m_pHint = new CSprite((char*)"hint128.png");
    }
    else if (_iOS==IPAD)
    {
        m_pBoard = new CSprite((char*)"board512.png");
        m_pBoard->SetPosition(256,64);
        m_pHint = new CSprite((char*)"hint.png");
    }
    else if (_iOS==IPHONE4)
    {
        m_pBoard = new CSprite((char*)"board512.png");
        m_pBoard->SetPosition(224,0);
        m_pHint = new CSprite((char*)"hint.png");
    }
    else if (_iOS==IPHONE5)
    {
        m_pBoard = new CSprite((char*)"board512.png");
        m_pBoard->SetPosition(312,0);
        m_pHint = new CSprite((char*)"hint.png");
    }
    
	m_pGameOver = new CSprite((char*)"gameover", _iOS);
    m_pBlack = new CSprite((char*)"black100",_iOS);
    ...
    if (_iOS == IPAD_HD)
    {
        m_pScoreMulti[0] = new CSprite((char*)"x1b.png");
        m_pScoreMulti[1] = new CSprite((char*)"x2b.png");
        m_pScoreMulti[2] = new CSprite((char*)"x3b.png");
        m_pScoreMulti[3] = new CSprite((char*)"x4b.png");
        m_pScoreMulti[4] = new CSprite((char*)"x5b.png");
        m_pScoreMulti[5] = new CSprite((char*)"x6b.png");
        m_pScoreMulti[6] = new CSprite((char*)"x7b.png");
        m_pScoreMulti[7] = new CSprite((char*)"x8b.png");
        m_pScoreMulti[8] = new CSprite((char*)"x9b.png");
        m_pScoreMulti[9] = new CSprite((char*)"x10b.png");
    }
    else
    {
        m_pScoreMulti[0] = new CSprite((char*)"x1b.png");
    ...
    // odpowiednie tło dla etapu
    
	switch(iLevel)
	{
		case 1:
            m_pBackground = new CSprite((char*)"level01",_iOS);

            m_pParticleManager = new CParticle2DManager((char*)"k2.png", 50,
                                                       -100,-100,pScreen->iSizeX()+100,pScreen->iSizeX()+100,
                                                       0.1f,0.1f,1.3f,1.3f,
                                                       0.5f, -.001f,.001f,
                                                       0.5f, -.5f,.5f,
                                                       100,1000);
		...
		case 2:
            m_pBackground = new CSprite((char*)"level02",_iOS);
		...
		case 3:
            m_pBackground = new CSprite((char*)"level03",_iOS);
			
            m_pParticleManager = new CParticle2DManager((char*)"k3.png", 50,
                                                        -100,-100,pScreen->iSizeX()+100,pScreen->iSizeX()+100,
                                                        0.1f,0.1f,1.3f,1.3f,
                                                        0.5f, -.001f,.001f,
                                                        0.5f, -.5f,.5f,
		...
		case 4:
            m_pBackground = new CSprite((char*)"level04",_iOS);

            m_pParticleManager = new CParticle2DManager((char*)"k5.png", 50,
                                                        -100,-100,pScreen->iSizeX()+100,pScreen->iSizeX()+100,
                                                        0.1f,0.1f,1.3f,1.3f,
                                                        0.5f, -.001f,.001f,
                                                        0.5f, -.5f,.5f,
		...
		case 5:
            m_pBackground = new CSprite((char*)"level05",_iOS);
		...
		case 6:
            m_pBackground = new CSprite((char*)"level06",_iOS);
		...
		case 7:
            m_pBackground = new CSprite((char*)"level07",_iOS);
			
            m_pParticleManager = new CParticle2DManager((char*)"m2.png", 50,
                                                        -100,-100,pScreen->iSizeX()+100,pScreen->iSizeX()+100,
                                                        0.1f,0.1f,1.3f,1.3f,
                                                        0.5f, -.001f,.001f,
                                                        0.5f, -.5f,.5f,
    ...
    if (_iOS == IPAD_HD)
    {
        m_pGem[0] = new CSprite((char*)"gem1b.png");
        m_pGem[1] = new CSprite((char*)"gem2b.png");
        m_pGem[2] = new CSprite((char*)"gem3b.png");
        m_pGem[3] = new CSprite((char*)"gem4b.png");
        m_pGem[4] = new CSprite((char*)"gem5b.png");
        m_pGem[5] = new CSprite((char*)"gem6b.png");
        m_pGem[6] = new CSprite((char*)"gem7b.png");
        m_pGem[7] = new CSprite((char*)"gem8b.png");
        m_pGem[8] = new CSprite((char*)"gem9b.png");
        m_pGem[9] = new CSprite((char*)"gem10b.png");
        m_pGem[10] = new CSprite((char*)"gem11b.png");
       
        _pGemRock = new CAnim((char*)"gem8b",23,128,128);
        _pGemDiamond = new CAnim((char*)"gem9b",23,128,128);
        _pGemRainbow = new CAnim((char*)"gem10b",23,128,128);
        _pGemBomb = new CAnim((char*)"gem11b",23,128,128);
    }
    else
    {
        m_pGem[0] = new CSprite((char*)"gem1.png");
        m_pGem[1] = new CSprite((char*)"gem2.png");
        m_pGem[2] = new CSprite((char*)"gem3.png");
        m_pGem[3] = new CSprite((char*)"gem4.png");
        m_pGem[4] = new CSprite((char*)"gem5.png");
        m_pGem[5] = new CSprite((char*)"gem6.png");
        m_pGem[6] = new CSprite((char*)"gem7.png");
        m_pGem[7] = new CSprite((char*)"gem8.png");
        m_pGem[8] = new CSprite((char*)"gem9.png");
        m_pGem[9] = new CSprite((char*)"gem10.png");
        m_pGem[10] = new CSprite((char*)"gem11.png");
        
        _pGemRock = new CAnim((char*)"gem8",23,64,64);
        _pGemDiamond = new CAnim((char*)"gem9",23,64,64);
        _pGemRainbow = new CAnim((char*)"gem10",23,64,64);
        _pGemBomb = new CAnim((char*)"gem11",23,64,64);
    }
    ...
    if (_iOS == IPAD_HD)
    {
        ...
        m_pButtonHint->SetPosition(1600,1170);
        m_pButtonHint->SetHotCoords(1600,1170,1600+256,1170+256);
    ...
    else if (_iOS == IPAD)
    {
        ...
        m_pButtonHint->SetPosition(800,600);
        m_pButtonHint->SetHotCoords(800,600,800+128,600+128);
    ...
    {
        m_pButtonHint = new CButton((char*)"hint_click_128px.png",(char*)"hint_over_128px.png",(char*)"hint_static_128px.png",0,0,128,128);
        m_pButtonHint->SetPosition(950,500);
        m_pButtonHint->SetHotCoords(950,500,950+128,500+128);
    ...
    {
        m_pButtonHint = new CButton((char*)"hint_click_128px.png",(char*)"hint_over_128px.png",(char*)"hint_static_128px.png",0,0,128,128);
        m_pButtonHint->SetPosition(800,500);
        m_pButtonHint->SetHotCoords(800,500,800+128,500+128);
    ...
    if (_iOS == IPAD_HD)
    {
        _pScore100 = new CSprite((char*)"score100_128.png");
        _pScore250 = new CSprite((char*)"score250_128.png");
        _pScore500 = new CSprite((char*)"score500_128.png");
        _pScore1000 = new CSprite((char*)"score1000_128.png");
    }
    else
    {
        _pScore100 = new CSprite((char*)"score100_64.png");
        _pScore250 = new CSprite((char*)"score250_64.png");
        _pScore500 = new CSprite((char*)"score500_64.png");
        _pScore1000 = new CSprite((char*)"score1000_64.png");
    }
	...
	_pMSuper = new CSound((char*)"super.wav");
	_pMRainbow = new CSound((char*)"rainbow.wav");
	_pMDiamond = new CSound((char*)"diamond.wav");
	_pMLevelUp = new CSound((char*)"level_up.wav");
	_pMClick = new CSound((char*)"click.wav");
	_pMBomb = new CSound ((char*)"bomb.wav");
	_pGameOverSFX = new CSound((char*)"GameOver.wav");
	_pTikTakSFX = new CSound((char*)"tiktak.wav");
    
	// offset dla tablicy
    
	if (_iOS == IPHONE4 || _iOS == IPHONE5)
	{
		_uiBoardOffsetY = 0;
	}
	else if (_iOS == IPAD)
...
void eIngame::Close(void)
{
    ...
    SafeDelete(_pMSuper);
    SafeDelete(_pMRainbow);
    SafeDelete(_pMDiamond);
    SafeDelete(_pMLevelUp);
    SafeDelete(_pMClick);
    SafeDelete(_pMBomb);
    SafeDelete(_pGameOverSFX);
    SafeDelete(_pTikTakSFX);
...
bool eIngame::isMatch3(unsigned long ulTimer)
{
	...
	for (h1=0; h1<=5; h1++)
	{
		for (h2=0; h2<=5; h2++)
		{
				...
				m_cBoard[adres]<GEM_ROCK)
			{
				...
				m_iCoin[adres] = ulTimer;	// dodajemy monetÍ
				...
				// dodajemy czas, doúwiadczenie, punkty
	...
	for (h1=0; h1<=5; h1++)
	{
		for (h2=0; h2<=5; h2++)
		{
				...
				m_cBoard[adres]<GEM_ROCK)
			{
				...
				m_iCoin[adres+2] = ulTimer;	// dodajemy monetÍ
	...
	for (h1=0; h1<=5; h1++)
	{
		for (h2=0; h2<=5; h2++)
		{
				...
				m_cBoard[adres]<GEM_ROCK)
			{
				...
				m_iCoin[((h1+2)*8)+h2] = ulTimer;	// dodajemy monetÍ
	...
	// szukamy 4 kamyczkÛw w jednej linii
                ...
                
            {
                if (h1==7)	// w ostatniej lini nie sprawdzamy czy pod klockami jest spacja
                {
                    if (m_cBoard[adres]<GEM_ROCK)		// tylko kamyki standardowe
                    {
                        ...
                        m_iCoin[adres+1] = ulTimer;	// dodajemy monetÍ
                        _sCoin[adres+1] = 100;		// dajemy +250
                        m_iCoin[adres+2] = ulTimer;	// dodajemy monetÍ
                        _sCoin[adres+2] = 100;		// dajemy +250
                        m_iCoin[adres+3] = ulTimer;	// dodajemy monetÍ
        ...
        for (h2=0; h2<=7; h2++)
        {
                ...
                m_fBoardDeltaX[((h1+3)*8)+h2] == 0 && m_fBoardDeltaY[((h1+3)*8)+h2] == 0)
            {
                if (m_cBoard[adres]<GEM_ROCK)		// tylko kamyki standardowe
                {
                    ...
                    m_iCoin[adres] = ulTimer;	// dodajemy monetÍ
                    _sCoin[adres] = 100;		// dajemy +250
                    m_iCoin[((h1+1)*8)+h2] = ulTimer;	// dodajemy monetÍ
                    _sCoin[((h1+1)*8)+h2] = 100;		// dajemy +250
                    m_iCoin[((h1+2)*8)+h2] = ulTimer;	// dodajemy monetÍ
                    _sCoin[((h1+2)*8)+h2] = 100;		// dajemy +250
                    m_iCoin[((h1+3)*8)+h2] = ulTimer;	// dodajemy monetÍ
...
//=== uøywane do podpowiedzi i sprawdzenia czy musimy wylosowaÊ na nowo klocki
...
//=== TODO: delta przesuniÍcia klockÛw powinna byÊ liczona z timera
...
//=== rysowanie paskÛw postÍpu i pasku czasu
...
void eIngame::DrawProgressBar(unsigned long ulTimer)
{
	...
	{
		iTimeX1 = 334; iTimeY1 = 634;
		iTimeX2 = 700; iTimeY2 = 658;
        
		iExpX1 = 334; iExpY1 = 676;
		iExpX2 = 700; iExpY2 = 698;
	}
	else if (_pScreen->iSizeX()==1136)  // iphone5
	{
		iTimeX1 = 425; iTimeY1 = 530;
		iTimeX2 = 425 + 300; iTimeY2 = 530 + 18;
        
		iExpX1 = 425; iExpY1 = 565;
		iExpX2 = 425 + 300; iExpY2 = 565 + 18;
	}
	else if (_pScreen->iSizeX() == 960) // iphone4
	{
		iTimeX1 = 358; iTimeY1 = 530;
		iTimeX2 = 358 + 250; iTimeY2 = 530 + 18;
        
		iExpX1 = 358; iExpY1 = 565;
		iExpX2 = 358 + 250; iExpY2 = 565 + 18;
	}
	else if (_pScreen->iSizeX() == 2048)
	{
		iTimeX1 = 668; iTimeY1 = 1270;
		iTimeX2 = 668 + 730; iTimeY2 = 1270 + 48;
        
		iExpX1 = 668; iExpY1 = 1350;
		iExpX2 = 668 + 730; iExpY2 = 1350 + 48;
	}
    
    drawRect(iTimeX1,iTimeY1,iTimeX2, iTimeY2,0.25f,0.25f,0.25f,0.5f);     // szary pasek - czas
    drawRect(iExpX1,iExpY1,iExpX2,iExpY2,0.25f,0.25f,0.25f,0.5f);           // szary pasek - doświadczenie
    ...
    drawRect(iTimeX1,iTimeY1,(int)iTimeX1+((iTimeX2-iTimeX1)*fCurrent),(int)iTimeY1+(iTimeY2-iTimeY1),0.75f,0.0f,0.0f,0.8f);
    ...
    drawRect(iExpX1,iExpY1,(int)iExpX1+((iExpX2-iExpX1)*fCurrent),(int)iExpY1+(iExpY2-iExpY1),0.0f,0.75f,0.0f,0.8f);
...
int eIngame::Render(unsigned long ulTimer, CTouch *pTouch)
{
	...
	if (m_ulTimerStart == 0)		// czy to pierwsza renderowana klatka ?
	{
		...
		if (pTouch->isPressed())	// nie przechwytujmy clicku z menu
			m_bMouseLock = true;
...
/*
		...
		{
			_pFXManager->Add(FX_SMALL_LOOP, 850, 640, 1.0f, 0.75f, 0.5f, 1, ulTimer, 100000);	// particle pod latarniπ
		...
		{
			_pFXManager->Add(FX_SMALL_LOOP, 1015, 640, 1.0f, 0.75f, 0.5f, 1, ulTimer, 100000);	// particle pod latarniπ
		...
		{
			_pFXManager->Add(FX_SMALL_LOOP, 1420, 888, 1.0f, 0.75f, 0.5f, 1, ulTimer, 100000);	// particle pod latarniπ
		...
		{
			_pFXManager->Add(FX_SMALL_LOOP, 1900, 1200, 1.0f, 0.75f, 0.5f, 1, ulTimer, 100000);	// particle pod latarniπ
 ...
 */
	...
	if (m_bMouseLock && !pTouch->isPressed())
		m_bMouseLock=false;
	...
	// jezeli cala dolna linia to same kamienie, to kasujemy tπ linie
    
	if ( (m_cBoard[63] == GEM_ROCK) && (m_cBoard[62] == GEM_ROCK) &&
         (m_cBoard[61] == GEM_ROCK) && (m_cBoard[60] == GEM_ROCK) &&
         (m_cBoard[59] == GEM_ROCK) && (m_cBoard[58] == GEM_ROCK) &&
         (m_cBoard[57] == GEM_ROCK) && (m_cBoard[58] == GEM_ROCK) )
	...
	if (!m_bFallLock)
	{
		for (h1=7; h1>=1; h1--)	// sprawdzamy pionowo od do≥u do gÛry
		{
			if (!m_bFallLock)
			{
				for (h2=0; h2<=7; h2++)
	...
	for (h1=0; h1<8; h1++)
	{
		for (h2=0; h2<8; h2++)
		{
			...
			{
				if ((ulTimer - m_iCoin[(h1*8)+h2])>200.0f) // czy minal czas 255 ?
				{
					m_iCoin[(h1*8)+h2]=-1;	// zerujemy
				}
				else
				{
					float fAlfa = ((((float)(ulTimer-m_iCoin[(h1*8)+h2])/200.0f)));
	...
	if (pTouch->fClickDeltaX()>_ucGemSize || pTouch->fClickDeltaY()>_ucGemSize || pTouch->fClickDeltaX()<-_ucGemSize || pTouch->fClickDeltaY()<-_ucGemSize)
	{
		m_bMouseLock = false;
        pTouch->iStartX(pTouch->iGetX());
        pTouch->iStartY(pTouch->iGetY());
	}
	...
	if (pTouch->iGetX()>((_pScreen->iSizeX()/2)-(m_pBoard->fSizeX()/2)) && pTouch->iGetX()<((_pScreen->iSizeX()/2)+(m_pBoard->fSizeX()/2)) &&
		pTouch->iGetY()>_uiBoardOffsetY && pTouch->iGetY()<(m_pBoard->fSizeX()+_uiBoardOffsetY) && pTouch->isPressed() && !m_bMouseLock && !m_bGameOver && !m_bFallLock)
	{
		h1 = (int)((pTouch->iGetX()-((_pScreen->iSizeX()/2)-(m_pBoard->fSizeX()/2)))/h3);	// X na tablicy
		h2 = (int)((pTouch->iGetY()-_uiBoardOffsetY)/h3);	// Y na tablicy
		...
		else if (m_cClickedB==-1)
		{
			if (m_cClickedA!=(h2*8)+h1)			// czy to nie ten sam co #1 ?
			{
				...
				else	// to nie jest click obok wiÍc to bÍdzie teraz nasz klocek #1
				{
					m_cClickedA=(h2*8)+h1;
					m_iClickedAx = ((_pScreen->iSizeX()/2)-(m_pBoard->fSizeX()/2)) +(h1*h3);
					m_iClickedAy = _uiBoardOffsetY + (h2*h3);
	...
	if (!m_bGameOver)
	{
		...
		{
			m_pScoreMulti[m_ucScoreMulti]->Position(800, _pScreen->iSizeY() / 2 - 50);
		}
		else if (_pScreen->iOS() == IPHONE5)
		{
			m_pScoreMulti[m_ucScoreMulti]->Position(900, _pScreen->iSizeY() / 2 - 50);
		}
		else if (_pScreen->iOS() == IPAD_HD)
		{
			m_pScoreMulti[m_ucScoreMulti]->Position(1700, _pScreen->iSizeY() / 2 - 200);
		}
...
void eIngame::drawRect( short x1,short y1 , short x2 , short y2 , float r , float g , float b, float a )
{
    GLfloat rect[] = {
        y1, x1,
        y2, x1,
