...
// 10 zetknij ze sobπ dwa teczowe kamienie
...
private:
	...
	int					_iIndex;					// index sprawdzanego elementu

	CSprite				*_pBackground;				// tlo
	CButton				*_pExitButton;				// wyjscie z helpa

	CSprite				*_pTroophy[21];				// obrazy dla rysowanych trofe
	...
	CTween				*_pTween;					// do skalowania naszego obiektu

	Mix_Chunk			*_pTroophySFX;				// efekt düwiekowy
};
