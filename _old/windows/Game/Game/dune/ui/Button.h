...
public:
	...
	void setPosition(long lX, long lY);    // ustawia wspó³rzêdne do rysowania	
	void setHotCoords(long lXStart, long lYStart, long lXEnd, long lYEnd);  // ustawia wspó³rzêdne aktywnego obszaru
