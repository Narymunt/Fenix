...
CSpriteFont::CSpriteFont(CScreen *pScreen)
{
	...
	_charTable[0] = new CSprite(pScreen,"FONT_A");
	_charTable[1] = new CSprite(pScreen,"FONT_B");
	_charTable[2] = new CSprite(pScreen,"FONT_C");
	_charTable[3] = new CSprite(pScreen,"FONT_D");
	_charTable[4] = new CSprite(pScreen,"FONT_E");
	_charTable[5] = new CSprite(pScreen,"FONT_F");
	_charTable[6] = new CSprite(pScreen,"FONT_G");
	_charTable[7] = new CSprite(pScreen,"FONT_H");
	_charTable[8] = new CSprite(pScreen,"FONT_I");
	_charTable[9] = new CSprite(pScreen,"FONT_J");
	_charTable[10] = new CSprite(pScreen,"FONT_K");
	_charTable[11] = new CSprite(pScreen,"FONT_L");
	_charTable[12] = new CSprite(pScreen,"FONT_M");
	_charTable[13] = new CSprite(pScreen,"FONT_N");
	_charTable[14] = new CSprite(pScreen,"FONT_O");
	_charTable[15] = new CSprite(pScreen,"FONT_P");
	_charTable[16] = new CSprite(pScreen,"FONT_Q");
	_charTable[17] = new CSprite(pScreen,"FONT_R");
	_charTable[18] = new CSprite(pScreen,"FONT_S");
	_charTable[19] = new CSprite(pScreen,"FONT_T");
	_charTable[20] = new CSprite(pScreen,"FONT_U");
	_charTable[21] = new CSprite(pScreen,"FONT_V");
	_charTable[22] = new CSprite(pScreen,"FONT_W");
	_charTable[23] = new CSprite(pScreen,"FONT_X");
	_charTable[24] = new CSprite(pScreen,"FONT_Y");
	_charTable[25] = new CSprite(pScreen,"FONT_Z");
	_charTable[26] = new CSprite(pScreen,"FONT_COMA");
	_charTable[27] = new CSprite(pScreen,"FONT_0");
	_charTable[28] = new CSprite(pScreen,"FONT_1");
	_charTable[29] = new CSprite(pScreen,"FONT_2");
	_charTable[30] = new CSprite(pScreen,"FONT_3");
	_charTable[31] = new CSprite(pScreen,"FONT_4");
	_charTable[32] = new CSprite(pScreen,"FONT_5");
	_charTable[33] = new CSprite(pScreen,"FONT_6");
	_charTable[34] = new CSprite(pScreen,"FONT_7");
	_charTable[35] = new CSprite(pScreen,"FONT_8");
	_charTable[36] = new CSprite(pScreen,"FONT_9");
}
